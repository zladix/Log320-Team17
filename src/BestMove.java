...
public class BestMove {
	...
	public BestMove(Move bestMove, int score) {
        this.bestMove = bestMove;
        this.score = score;
    }
}

//Méthode temp trouvé sur internet
...
protected BestMove MinMax(int alpha, int beta, int maxDepth,int playerColor) {
	...
	//Transformer en itérateur
    Iterator<Move> movesIterator = moves.iterator();
    BestMove bestMove = new bestMove();
    //Si le joueur est celui que notre algorithme contrôle , on maximise / Sinon On Minimise
    ...
    //-----------------------------------------
    //Boucle sur les coups possibles -> c'est la qu'on va devoir set les heuristiques "La stratégie".
