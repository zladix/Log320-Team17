...
class Client {
	...
	public static double setHeuristique(String move, boolean isWhite){
		...
		//transformer le mouvement d'arr�t en valeur num�rique
		//le A majuscule = 65 en ascii donc je r�duit la valeur recu a 0 pour pouvoir �tre bien positionn� dans le tableau
	...
	public static double calculerHeuristique(int posX, int posY, boolean isWhite)
	{
		...
		//�tape 1 :calcul de la distance par rapport au centre je sous entend que  4X4 est le centre
		...
		//�tape 2 regarder s'il y a des pièces de la même couleur autour du moment d'arrivé
		...
		if(posX < 7){
			//�tape 3 regarder à l'horizontale
